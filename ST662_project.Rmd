...
ggplot(data, aes(x=month, y=avg_delay)) +
  ...
  scale_x_continuous(breaks=1:12, name = labels=c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sept","Oct","Nov","Dec"))
...
ggplot(data = flights, aes(x = carrier , fill = arr_type)) + labs(title = 'Count of delayed/on-time flights by carrier') + geom_bar(position = position_dodge(preserve = "single")) 
```
